  ...
  <div>
    <v-card flat class="lightblue" :resize="moveIcon">
      <v-form ref="form" v-model="valid" lazy-validation>   
        ...
        <v-layout row wrap>
          <v-flex xs7>
            <v-switch label="Enable Free Shipping?" :disabled="!expedited_speed_enabled" v-model="expedited_free_enabled" color="indigo"></v-switch>
          </v-flex>
        </v-layout>
    ...
    <div class="text-xs-center">
      <v-bottom-sheet inset v-model="expedited_turned_off_sheet">
        <v-card dark color="red darken-1">
          <v-card-title>
            <h1 v-if="expedited_turned_off_sheet" key="good_turn_off" class="headline pb-2 oswald mx-auto">All Good. You just turned off your expedited shipping rate!</h1>
          </v-card-title>
        </v-card>  
      </v-bottom-sheet>
    </div>
